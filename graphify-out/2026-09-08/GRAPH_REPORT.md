# Graph Report - doren  (2026-09-08)

## Corpus Check
- 293 files · ~215,690 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1606 nodes · 2957 edges · 181 communities (124 shown, 57 thin omitted)
...
### Community 7 - "two-factor-setup-modal.tsx"
Cohesion: 0.06
...
Cohesion: 0.14
Nodes (14): Badge(), badgeVariants, AdminDashboard(), LowStockProduct, Metrics, Props, RecentOrder, SalesPoint (+6 more)

### Community 9 - "dropdown-menu.tsx"
Cohesion: 0.10
Nodes (22): NavUser(), DropdownMenu(), DropdownMenuCheckboxItem(), DropdownMenuContent(), DropdownMenuGroup(), DropdownMenuItem(), DropdownMenuLabel(), DropdownMenuRadioItem() (+14 more)
...
### Community 14 - "Illuminate\Database\Console\Seeds\WithoutModelEvents"
Cohesion: 0.26
...
Cohesion: 0.13
Nodes (7): User, Illuminate\Contracts\Auth\MustVerifyEmail, Illuminate\Foundation\Auth\User, Illuminate\Notifications\Notifiable, Laravel\Fortify\Contracts\PasskeyUser, Laravel\Fortify\PasskeyAuthenticatable, Laravel\Fortify\TwoFactorAuthenticatable
...
Cohesion: 0.16
Nodes (17): AdminPagination(), AdminPaginationMeta, AdminPaginationProps, pageNumbers(), pageUrl(), AdminBannersIndex(), Banner, bannerFileExtension() (+9 more)
...
### Community 38 - "sales/index.tsx"
Cohesion: 0.20
Nodes (15): AdminApiState(), Props, Props, Card(), CardContent(), CardDescription(), CardHeader(), CardTitle() (+7 more)

### Community 39 - "Order"
Cohesion: 0.16
Nodes (5): CreateCheckoutOrder, OrderController, UpdateOrderRequest, Order, OrderFactory
...
Cohesion: 0.13
Nodes (6): StoreProductCategoryRequest, UpdateStorefrontBannerRequest, TwoFactorAuthenticationRequest, StoreCheckoutRequest, Illuminate\Foundation\Http\FormRequest, Laravel\Fortify\InteractsWithTwoFactorState
...
### Community 64 - "Illuminate\Contracts\Validation\ValidationRule"
Cohesion: 0.19
Nodes (5): ResetUserPassword, PasswordUpdateRequest, ProfileDeleteRequest, Illuminate\Contracts\Validation\ValidationRule, Laravel\Fortify\Contracts\ResetsUserPasswords
...
Cohesion: 0.18
Nodes (6): OrderItemFactory, ProductCategoryFactory, ProductVariantFactory, ProductVariantImageFactory, StorefrontBannerFactory, Illuminate\Database\Eloquent\Factories\Factory

### Community 95 - "Illuminate\Database\Eloquent\Factories\HasFactory"
Cohesion: 0.20
...
Cohesion: 0.16
Nodes (5): CustomerController, ProductCategoryController, StoreSettingController, UpdateProductCategoryRequest, Illuminate\Http\JsonResponse

### Community 100 - "products/index.tsx"
Cohesion: 0.12
Nodes (23): Select(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), AdminProductsIndex(), CategoryOption, centsToPrice() (+15 more)

### Community 103 - "sidebar.tsx"
Cohesion: 0.11
Nodes (31): AdminNavSection, adminNavSections, AppSidebar(), footerNavItems, mainNavItems, Sidebar(), SidebarContent(), SidebarContext (+23 more)

### Community 104 - "checkout.tsx"
Cohesion: 0.38
Nodes (6): CartItem, Checkout(), CheckoutForm, fieldLabel(), formatPrice(), Props

### Community 106 - "ProductCategory"
Cohesion: 0.22
Nodes (5): ProductCategory, ProductFactory, colorImageUrls(), productPayload(), variantsPayload()
...
Cohesion: 0.19
Nodes (11): AppContent(), Props, AppShell(), Props, AppSidebarHeader(), AdminLayout(), AppSidebarLayout(), AppLayout() (+3 more)

### Community 122 - "cn"
Cohesion: 0.09
Nodes (30): AlertError(), AppHeader(), Alert(), AlertDescription(), AlertTitle(), alertVariants, CardFooter(), Checkbox() (+22 more)

### Community 124 - "ProfileController.php"
Cohesion: 0.14
Nodes (5): CartItemController, ProfileController, SecurityController, StoreCartItemRequest, Illuminate\Http\RedirectResponse

### Community 125 - "orders/index.tsx"
Cohesion: 0.22
Nodes (14): useAdminApi(), formatDate(), formatMoney(), titleCase(), AdminCategoriesIndex(), AdminCustomersIndex(), AdminOrdersIndex(), Option (+6 more)
...
Cohesion: 0.09
Nodes (11): EnsureUserIsAdmin, HandleAppearance, HandleInertiaRequests, SecurityHeaders, UpdateProductRequest, SafeImageUrl, Closure, Illuminate\Foundation\Configuration\Middleware (+3 more)
...
- **Why does `cn()` connect `cn` to `utils.ts`, `products/index.tsx`, `sales/index.tsx`, `two-factor-setup-modal.tsx`, `admin/dashboard.tsx`, `dropdown-menu.tsx`, `sidebar.tsx`, `use-appearance.tsx`, `breadcrumbs.tsx`, `categories/index.tsx`, `app-header.tsx`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `Controller` connect `Controller` to `Illuminate\Http\JsonResponse`, `StorefrontBanner`, `ProductVariant.php`, `Api/Admin/DashboardController.php`, `Order`, `Product`, `CheckoutController`, `ProfileController.php`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `ProductCategory` connect `ProductCategory` to `Illuminate\Http\JsonResponse`, `StorefrontBanner`, `Api/Admin/DashboardController.php`, `Product`, `Illuminate\Database\Console\Seeds\WithoutModelEvents`, `ProductVariant`, `Controller`, `Illuminate\Database\Eloquent\Factories\Factory`, `Illuminate\Database\Eloquent\Factories\HasFactory`?**
