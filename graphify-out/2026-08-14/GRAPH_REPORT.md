...
## Corpus Check
- 265 files · ~203,174 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1423 nodes · 2568 edges · 155 communities (111 shown, 44 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4bf55358`
...
## Communities (155 total, 44 thin omitted)
...
Cohesion: 0.12
Nodes (25): AdminNavSection, adminNavSections, AppHeader(), AppSidebar(), footerNavItems, mainNavItems, NavFooter(), NavMain() (+17 more)
...
Cohesion: 0.07
Nodes (41): DeleteUser(), Heading(), InputError(), ManagePasskeys(), Props, ManageTwoFactor(), Props, PasskeyItem() (+33 more)

### Community 8 - "Illuminate\Database\Console\Seeds\WithoutModelEvents"
Cohesion: 0.26
...
Cohesion: 0.11
Nodes (5): ProductController, ProductShowController, StoreProductRequest, UpdateProductRequest, Product
...
### Community 18 - "ProductVariant"
Cohesion: 0.18
Nodes (3): ProductVariant, OrderItemFactory, Illuminate\Database\Eloquent\Relations\HasMany

### Community 19 - "ProductCategory"
Cohesion: 0.14
Nodes (6): OrderItem, ProductCategory, ProductFactory, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\Model, Illuminate\Database\Eloquent\Relations\BelongsTo

### Community 21 - "devDependencies"
Cohesion: 0.13
Nodes (15): babel-plugin-react-compiler, eslint-config-prettier, eslint-import-resolver-typescript, @eslint/js, @laravel/vite-plugin-wayfinder, devDependencies, babel-plugin-react-compiler, eslint (+7 more)

### Community 22 - "Tailwind CSS Development"
Cohesion: 0.14
Nodes (13): Basic Usage, Common Patterns, Common Pitfalls, CSS-First Configuration, Dark Mode, Documentation, Flexbox Layout, Grid Layout (+5 more)

### Community 23 - "app-logo.tsx"
Cohesion: 0.27
Nodes (5): AppLogo(), AppLogoIcon(), AuthSimpleLayout(), AuthLayout(), AuthLayoutProps

### Community 24 - "products/index.tsx"
Cohesion: 0.07
Nodes (68): AdminApiState(), Props, Props, Props, Badge(), badgeVariants, Card(), CardContent() (+60 more)

### Community 25 - "Controller"
Cohesion: 0.06
Nodes (24): CustomerController, DashboardController, OrderController, ProductCategoryController, ProductController, StorefrontBannerController, StoreSettingController, CartController (+16 more)
...
Cohesion: 0.12
Nodes (6): CustomerController, ProductCategoryController, StoreSettingController, StoreProductCategoryRequest, UpdateProductCategoryRequest, Illuminate\Http\JsonResponse
...
Cohesion: 0.12
Nodes (21): NavUser(), Sidebar(), SidebarContext, SidebarGroupAction(), SidebarInput(), SidebarMenuAction(), SidebarMenuBadge(), SidebarMenuSkeleton() (+13 more)

### Community 96 - "Illuminate\Database\Eloquent\Factories\Factory"
Cohesion: 0.15
Nodes (7): OrderFactory, ProductCategoryFactory, ProductVariantFactory, StorefrontBannerFactory, UserFactory, Illuminate\Database\Eloquent\Factories\Factory, static

### Community 97 - "Illuminate\Foundation\Http\FormRequest"
Cohesion: 0.14
Nodes (6): PasswordUpdateRequest, TwoFactorAuthenticationRequest, StoreCartItemRequest, StoreCheckoutRequest, Illuminate\Foundation\Http\FormRequest, Laravel\Fortify\InteractsWithTwoFactorState
...
Cohesion: 0.14
Nodes (16): AdminSidebar(), AppContent(), Props, AppShell(), Props, AppSidebarHeader(), Breadcrumbs(), SidebarInset() (+8 more)

### Community 103 - "cn"
Cohesion: 0.10
Nodes (31): Avatar(), AvatarFallback(), AvatarImage(), Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList() (+23 more)
...
Cohesion: 0.15
Nodes (14): mainNavItems, Props, rightNavItems, Sheet(), SheetContent(), SheetDescription(), SheetFooter(), SheetHeader() (+6 more)
...
- **Why does `cn()` connect `cn` to `use-appearance.tsx`, `admin-sidebar.tsx`, `index.ts`, `utils.ts`, `dropdown-menu.tsx`, `alert-error.tsx`, `app-header.tsx`, `products/index.tsx`, `sidebar.tsx`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `@vitejs/plugin-react`, `@tailwindcss/vite`, `@types/react-dom`, `@laravel/passkeys`, `clsx`, `tw-animate-css`, `package.json`, `@types/react`, `@radix-ui/react-navigation-menu`, `input-otp`, `@radix-ui/react-avatar`, `@radix-ui/react-checkbox`, `@radix-ui/react-collapsible`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `lucide-react`, `@inertiajs/react`, `@radix-ui/react-select`, `@radix-ui/react-separator`, `@radix-ui/react-slot`, `@radix-ui/react-toggle-group`, `@radix-ui/react-tooltip`, `globals`, `react-dom`, `sonner`, `tailwind-merge`, `@radix-ui/react-label`, `@radix-ui/react-toggle`, `react`, `tailwindcss`, `typescript`, `vite`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `Controller` connect `Controller` to `Illuminate\Http\JsonResponse`, `Product`, `Order`, `StorefrontBanner`?**
