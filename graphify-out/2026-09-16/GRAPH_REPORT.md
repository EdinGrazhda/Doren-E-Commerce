...
## Corpus Check
- 325 files · ~222,704 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1743 nodes · 3296 edges · 187 communities (128 shown, 59 thin omitted)
...
Cohesion: 0.11
Nodes (22): Heading(), InputError(), ManagePasskeys(), Props, PasskeyItem(), PasskeyRegistration(), Props, PasskeyVerify() (+14 more)
...
Cohesion: 0.13
Nodes (11): AccessControlController, CampaignController, CustomerController, InventoryController, ProductCategoryController, ProductController, SalesController, StorefrontBannerController (+3 more)
...
Cohesion: 0.22
Nodes (9): class-variance-authority, @inertiajs/vite, laravel-vite-plugin, dependencies, class-variance-authority, @inertiajs/vite, laravel-vite-plugin, @radix-ui/react-checkbox (+1 more)
...
Cohesion: 0.17
Nodes (10): OrderController, EnsureUserIsAdmin, HandleAppearance, HandleInertiaRequests, SecurityHeaders, Closure, Illuminate\Foundation\Configuration\Middleware, Illuminate\Http\Request (+2 more)
