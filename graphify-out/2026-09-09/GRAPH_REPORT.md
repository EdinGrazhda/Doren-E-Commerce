# Graph Report - doren  (2026-09-09)

## Corpus Check
- 298 files · ~216,510 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1633 nodes · 3001 edges · 188 communities (126 shown, 62 thin omitted)
...
## Communities (188 total, 62 thin omitted)
...
Cohesion: 0.16
Nodes (6): StoreOptimizedImage, StorefrontBannerController, UpdateStorefrontBannerRequest, StorefrontBanner, GdImage, Illuminate\Http\UploadedFile

### Community 2 - "useIsMobile"
Cohesion: 0.53
...
Cohesion: 0.15
Nodes (15): Heading(), ManagePasskeys(), Props, ManageTwoFactor(), Props, PasskeyRegistration(), Props, TwoFactorRecoveryCodes() (+7 more)
...
Cohesion: 0.16
Nodes (10): InputError(), PasskeyVerify(), Props, PasswordInput(), Props, TextLink(), Checkbox(), Spinner() (+2 more)
...
Cohesion: 0.11
Nodes (13): CustomerController, DashboardController, InventoryController, OrderController, ProductCategoryController, ProductController, SalesController, StorefrontBannerController (+5 more)
...
Cohesion: 0.16
Nodes (15): DialogHeader(), AdminInventoryIndex(), emptyMovement, formatDateTime(), InventoryData, inventoryListingUrl(), InventoryMetrics, InventoryMovement (+7 more)

### Community 38 - "categories/index.tsx"
Cohesion: 0.09
Nodes (43): AdminApiState(), Props, Props, Badge(), badgeVariants, Card(), CardContent(), CardDescription() (+35 more)
...
Cohesion: 0.12
Nodes (7): StoreStorefrontBannerRequest, PasswordUpdateRequest, TwoFactorAuthenticationRequest, StoreCartItemRequest, Illuminate\Contracts\Validation\ValidationRule, Illuminate\Foundation\Http\FormRequest, Laravel\Fortify\InteractsWithTwoFactorState
...
Cohesion: 0.14
Nodes (7): InventoryMovementFactory, static, OrderItemFactory, ProductVariantFactory, ProductVariantImageFactory, StorefrontBannerFactory, Illuminate\Database\Eloquent\Factories\Factory

### Community 95 - "two-factor-setup-modal.tsx"
Cohesion: 0.14
Nodes (14): AlertError(), Props, TwoFactorSetupModal(), TwoFactorSetupStep(), InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot (+6 more)
...
Cohesion: 0.10
Nodes (27): Select(), SelectContent(), SelectItem(), SelectTrigger(), SelectValue(), Option, Order, OrderFormData (+19 more)

### Community 103 - "sidebar.tsx"
Cohesion: 0.10
Nodes (35): AdminNavSection, adminNavSections, AdminSidebar(), AppSidebar(), footerNavItems, mainNavItems, NavFooter(), NavMain() (+27 more)
...
### Community 111 - "laravel-best-practices/SKILL.md"
Cohesion: 0.33
Nodes (5): Consistency First, Decision Rules, How to Apply, Laravel Best Practices, Rule Index

### Community 112 - "delete-user.tsx"
Cohesion: 0.30
Nodes (10): DeleteUser(), PasskeyItem(), Props, Dialog(), DialogClose(), DialogContent(), DialogDescription(), DialogFooter() (+2 more)
...
Cohesion: 0.15
Nodes (14): AppContent(), Props, AppShell(), Props, AppSidebarHeader(), AdminLayout(), AppSidebarLayout(), AppLayout() (+6 more)

### Community 122 - "cn"
Cohesion: 0.08
Nodes (35): Breadcrumbs(), Alert(), AlertDescription(), AlertTitle(), alertVariants, Breadcrumb(), BreadcrumbEllipsis(), BreadcrumbItem() (+27 more)
...
Cohesion: 0.15
Nodes (10): HomeController, EnsureUserIsAdmin, HandleAppearance, HandleInertiaRequests, SecurityHeaders, Closure, Illuminate\Foundation\Configuration\Middleware, Illuminate\Http\Request (+2 more)
...
### Community 161 - "PasswordValidationRules.php"
Cohesion: 0.27
...
Cohesion: 0.24
Nodes (3): ProductCategory, ProductCategoryFactory, ProductFactory
...
- **Why does `cn()` connect `cn` to `useIsMobile`, `products/index.tsx`, `inventory/index.tsx`, `categories/index.tsx`, `button.tsx`, `sidebar.tsx`, `dropdown-menu.tsx`, `use-appearance.tsx`, `delete-user.tsx`, `login.tsx`, `utils.ts`, `app-header.tsx`, `two-factor-setup-modal.tsx`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `Controller` connect `Controller` to `Illuminate\Http\JsonResponse`, `StorefrontBanner`, `StoreCheckoutRequest`, `ProductVariant.php`, `Api/Admin/DashboardController.php`, `Order`, `Product`, `Illuminate\Http\Request`, `ProfileController.php`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `UpdateProductRequest` connect `UpdateProductRequest` to `Illuminate\Foundation\Http\FormRequest`, `StorefrontBanner`, `Product`?**
